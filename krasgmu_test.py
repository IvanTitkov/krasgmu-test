...
Эта диагностическая методика предназначена для учащихся, которые интересуются медициной и хотят понять, какие направления обучения в КрасГМУ им наиболее подходят.
...
if submitted:
    ...
    st.caption("езультаты носят ориентировочный характер и не являются окончательным профессиональным заключением. Тест помогает лучше понять свои склонности, но не заменяет личную консультацию специалиста.")
